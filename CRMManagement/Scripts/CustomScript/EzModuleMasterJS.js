...
function SubmitFormSave() {
    ...
    var EzModuleMasterVM = {
        ezModuleMaster: Header,
    ...
    if (oprType == "Create") {
        ...
        $.ajax({
            url: '/EzModuleMaster/Create',
            method: 'POST',
            contentType: 'application/json',
            data: JSON.stringify(EzModuleMasterVM),
            async: false,
